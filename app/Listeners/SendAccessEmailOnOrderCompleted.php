...
class SendAccessEmailOnOrderCompleted
{
     ...
     * usando o modelo de e-mail configurado em cada produto. O sendForOrder cobre apenas
     * o produto principal do pedido; sem este loop, os bumps ficariam sem entrega.
     */
